...
function LeetCodeIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden>
      <path d="M13.483 0a1.5 1.5 0 0 0-1.5 1.5v8.695L9.047 7.159a1.5 1.5 0 0 0-2.121 0L4.983 9.102a1.5 1.5 0 0 0 0 2.121l2.695 2.695-2.695 2.695a1.5 1.5 0 0 0 0 2.121l2.121 2.121a1.5 1.5 0 0 0 2.121 0l2.936-2.936v8.695a1.5 1.5 0 0 0 1.5 1.5h3a1.5 1.5 0 0 0 1.5-1.5V5.786a1.5 1.5 0 0 0-1.5-1.5h-3.017z" />
    </svg>
  );
}
...
function GfgIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden>
      <path d="M7.825 0l-3.43.002c-.248.002-.483.002-.724.002C2.153.004.824 1.33.824 3.068V24h7.39V7.4h8.16V0H7.825zm8.174 7.4V24h7.382c1.738 0 3.068-1.326 3.068-3.064V7.4h-10.45z" />
    </svg>
  );
}
      ...
      <div className="relative mx-auto max-w-7xl px-6 w-full grid lg:grid-cols-[1.05fr_1fr] gap-12 lg:gap-16 items-center">
        ...
        <div>
          ...
          <div className="mt-8 flex items-center gap-2.5 animate-in fade-in duration-700 delay-500">
            <SocialIcon href="https://github.com/Nikhil-VS1811" label="GitHub"><GithubIcon /></SocialIcon>
            <SocialIcon href="https://www.linkedin.com/in/nikhil-vs-8a7541288/" label="LinkedIn"><LinkedInIcon /></SocialIcon>
